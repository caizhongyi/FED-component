...
<fieldset>
 <div id="captchaimage"><a href="<?php echo $_SERVER['../../../plugins/jquery-validation-1.9.0/demo/captcha/PHP_SELF']; ?>" id="refreshimg" title="Click to refresh image"><img src="images/image.php?<?php echo time(); ?>" width="132" height="46" alt="Captcha image" /></a></div>
