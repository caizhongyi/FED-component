                ...
                then: function( /* fnDone, fnFail, fnProgress */ ) {
                    ...
                    return Deferred(function( newDefer ) {
                        ...
                        Deferred.each( tuples, function( i, tuple ) {
                            var fn = Deferred.isFunction( fns[ i ] ) && fns[ i ];
...
// Deferred helper
    ...
    Deferred.each = function( arr , fn ){
        for( var i = 0 ; i < arr.length ; i ++ ){
            fn( i , arr[i]);
        }
    }
    Deferred.isFunction = function( o ){
        return typeof (o) == 'object' && o.length
    }
    Deferred.extend = function( obj , ext ){
        for( var i in ext){
            obj[i] = ext[i]
        }
    }
    Deferred.inArray = function( elem, arr, i ) {
        return arr == null ? -1 : [].indexOf.call( arr, elem, i );
    }
    Deferred.Callbacks = function( options ) {
        function createOptions( options ) {
            var object = optionsCache[ options ] = {};
            Deferred.each( options.match( (/\S+/g) ) || [], function( _, flag ) {
                object[ flag ] = true;
            });
            return object;
        }
        ...
        var optionsCache = Deferred.optionsCache;
        options = typeof options === "string" ?
            ( optionsCache[ options ] || createOptions( options ) ) :
            Deferred.extend( {}, options );
        ...
        // Actual Callbacks object
            self = {
                ...
                has: function( fn ) {
                    return fn ? Deferred.inArray( fn, list ) > -1 : !!( list && list.length );
                },
