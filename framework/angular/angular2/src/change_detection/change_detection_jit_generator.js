...
Object.defineProperty(hydrateTemplate, "parameters", {get: function() {
    return [[$traceurRuntime.type.string], [$traceurRuntime.type.string], [$traceurRuntime.type.string], [$traceurRuntime.type.string], [$traceurRuntime.genericType(List, String)], [$traceurRuntime.genericType(List, String)]];
  }});
