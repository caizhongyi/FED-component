       ...
       if(_6.align.toLowerCase()!="left"){
        ...
        if(cp.length==0){
          ...
          if(cp.is(":visible")&&tl.Top==_2.Top&&tl.Left==_2.Left){
             ...
             $(".color",cp).unbind("mouseover").unbind("click").mouseover(function(){setSelect(this.bgColor.toUpperCase());
             }).click(function(){setColorValue(this.bgColor.toUpperCase(),_6);});
             ...
             function setDefaults(){
                return {setBackground:true,setValue:false,setColor:false,setText:false,align:"left",callback: function(){}};
             }
               ...
               function GetLoc(_17){
                  if(arguments.length!=1||_17==null){
                   ...
                   while(_17=_17.offsetParent){
                    ...
                    return {Top:_18,Left:_19-50,Width:_1a,Height:_1b};
                }
